              ...
              <div className="mb-12 w-full lg:mb-0 lg:w-5/12">
                <form>
                  ...
                  <div className="relative mb-6">
                    <input
                      type="text"
                      className="block w-full rounded-md border-2 border-gray-300 bg-transparent p-4 text-lg outline-none transition-colors hover:border-blue-500 focus:border-blue-500 dark:border-gray-700 dark:hover:border-blue-400 dark:focus:border-blue-400"
                      id="exampleInput90"
                      placeholder=" "
                    />
                    <label
                      htmlFor="exampleInput90"
                      className="absolute left-4 top-3 text-gray-500 transition-all peer-focus:-top-3 peer-focus:text-blue-500 peer-focus:text-sm peer-placeholder-shown:text-base peer-placeholder-shown:top-4 dark:text-gray-400 dark:peer-focus:text-blue-400"
                    >
                      Name
                    </label>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-md bg-blue-400 hover:bg-blue-600 p-1  font-semibold text-white transition-colors hover:bg-blue-600 dark:bg-blue-400 dark:hover:bg-blue-500"
                  >
                    Send
                  </button>
                </form>
